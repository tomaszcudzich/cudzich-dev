      ...
      items: [
        {
          ...
          name: 'Magazyn Opon',
          desc: 'System do zarządzania flotą pojazdów dla zakładu mięsnego. Pełna kontrola nad oponami, przeglądami i kosztami eksploatacji — w jednym miejscu, dostępna z każdego urządzenia.',
          ...
          stats: [
            { num: '100+', label: 'Pojazdów w systemie' },
      ...
      items: [
        {
          ...
          name: 'Magazyn Opon',
          desc: 'A fleet management system for a meat-processing plant. Full oversight of tyres, inspections and running costs — in one place, accessible from any device.',
          ...
          stats: [
            { num: '100+', label: 'Vehicles in system' },
